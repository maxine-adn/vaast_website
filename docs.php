...
<body>
    ...
    <main class="container-sm">
        ...
        <div class="card">
            ...
            <div id="vaast-fixation-param" class="table-around" style="min-width: 100%; overflow-x: auto;">
            ...
            <div id="vaast-image-param" class="table-around" style="min-width: 100%; overflow-x: auto; display: none">
                <div class="table-box m-0" style="overflow-x: auto; min-width: 400px; padding: 2rem 2rem 1rem 2rem ;">
            ...
            <div id="vaast-text-param" class="table-around" style="min-width: 100%; overflow-x: auto; display: none">
                <div class="table-box m-0" style="overflow-x: auto; min-width: 400px; padding: 2rem 2rem 1rem 2rem ;">
