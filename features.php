...
<body>
  ...
  ================================================== -->
    ...
    <div class="container-sm marketing">
      ...
      <div class="row featurette">
        ...
        <div class="col-md-7" id="boite-bw">
          <div id="boite-bw">
            <div class="dadscopy">
      ...
      return '<p>Unfortunately, this study is not compatible with your browser.</p>' +
        '<p>Please reopen this experiment from a supported browser (like Chrome or Firefox).</p>'
            ...
            <div class="dadscopy">
              ...
              <button type="button" class="copy-tl top-buttons" data-copy=".push-bc">
                <ion-icon name="copy-outline" class="copy-icon"></ion-icon>
                <span class="copy-label">Copy</span>
              </button>
            </div>
  ...
  button_label: "Submit",
            ...
            <div class="dadscopy">
              ...
              <button type="button" class="copy copy-tl top-buttons" data-copy=".push-ac">
                <ion-icon name="copy-outline" class="copy-icon"></ion-icon>
                <span class="copy-label">Copy</span>
              </button>
            </div>
  ...
  choices: [" "]
            ...
            <div class="dadscopy">
              ...
              <button type="button" class="copy copy-tl top-buttons" data-copy=".push-dq">
                <ion-icon name="copy-outline" class="copy-icon"></ion-icon>
                <span class="copy-label">Copy</span>
              </button>
            </div>
  ...
  loop_function: function() {
    ...
    return false;
            ...
            <div class="dadscopy">
              ...
              <button type="button" class="copy copy-tl top-buttons" data-copy=".push-age">
                <ion-icon name="copy-outline" class="copy-icon"></ion-icon>
                <span class="copy-label">Copy</span>
              </button>
            </div>
  ...
  button_label: "Confirm"
            ...
            <div class="dadscopy">
              ...
              <button type="button" class="copy copy-tl top-buttons" data-copy=".push-sex">
                <ion-icon name="copy-outline" class="copy-icon"></ion-icon>
                <span class="copy-label">Copy</span>
              </button>
            </div>
  ...
  button_label: "Confirm"
            ...
            <div class="dadscopy">
              ...
              <button type="button" class="copy copy-tl top-buttons" data-copy=".push-eng">
                <ion-icon name="copy-outline" class="copy-icon"></ion-icon>
                <span class="copy-label">Copy</span>
              </button>
            </div>
  ...
  button_label: "Submit"
            ...
            <div class="dadscopy">
              ...
              <button type="button" class="copy copy-tl top-buttons" data-copy=".push-ses">
                <ion-icon name="copy-outline" class="copy-icon"></ion-icon>
                <span class="copy-label">Copy</span>
              </button>
            </div>
  ...
  button_label: "Submit"
            ...
            <div class="dadscopy">
              ...
              <button type="button" class="copy copy-tl top-buttons" data-copy=".push-ed">
                <ion-icon name="copy-outline" class="copy-icon"></ion-icon>
                <span class="copy-label">Copy</span>
              </button>
            </div>
  ...
  button_label: "Submit"
            ...
            <div class="dadscopy">
              ...
              <button type="button" class="copy copy-tl top-buttons" data-copy=".push-rem">
                <ion-icon name="copy-outline" class="copy-icon"></ion-icon>
                <span class="copy-label">Copy</span>
              </button>
            </div>
