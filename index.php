...
<body>
  ...
  <main class="container-sm px-3">
    ...
    <p class="lead">
      ...
      The images are divided into 2 folders.
      The notion that surrounds all this how <a class="text-success-emphasis" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Coherent with real-world conditions">ecological</a> the environment is.
    ...
    <div class="container-sm px-4 py-2"> <!-- col-xxl-8 -->
      <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
        <div class="col-lg-6">
          <h2>In the <em>non_eco_env</em> images,</h2>
          <p class="lead">
            In these images, the environment is not ecological.
